...
class StaticPackageTests(unittest.TestCase):
    ...
    def test_manifest_contracts(self) -> None:
        contracts = {
            "code_provenance.tsv": ["source_path_or_pattern", "coverage", "status", "final_stage", "final_implementation", "note"],
            ...
            "missing_and_remote_only.tsv": ["item", "category", "local_status", "remote_status", "impact", "action"],
        }
