...
cat /data/home/sczd644/run/zsw_chrombpnet/alltissue.txt |while read id
do
chrombpnet pipeline \
        ...
        -b /data/home/sczd644/run/zsw_chrombpnet/${id}/data/bias_model/models/${id}_bias.h5 \
        -o /data/home/sczd644/run/zsw_chrombpnet/${id}/${id}_chrombpnet_model/
done
