...
save.image(file = "/data/home/sczd644/run/zsw_chrombpnet/03-syntax/01/output/MySession.RData") load("/data/home/sczd644/run/zsw_chrombpnet/03-syntax/01/output/MySession.RData")                #
